...
BEGIN
  ...
  LOOP
    ...
    IF l_name <> 'Aged Cheese' AND l_name <> 'Backstage passes to a concert' THEN
      IF l_quality > 0 THEN
        IF l_name <> 'Fine Italian Silk' THEN
    ...
    ELSE
      IF (l_quality < 50) THEN
        l_quality := l_quality + 1;
        IF l_name = 'Backstage passes to a concert' THEN
