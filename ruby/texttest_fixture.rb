...
items = [
  ...
  Item.new(name="+5 Dexterity Vest", sell_in=0, quality=0),
  Item.new(name="+5 Dexterity Vest", sell_in=-1, quality=8),
  Item.new(name="Aged Brie", sell_in=2, quality=0),
  Item.new(name="Aged Brie", sell_in=0, quality=9),
  Item.new(name="Aged Brie", sell_in=2, quality=50),
  Item.new(name="Aged Brie", sell_in=-1, quality=20),
  ...
  Item.new(name="Backstage passes to a TAFKAL80ETC concert", sell_in=0, quality=3),
  ...
  Item.new(name="Conjured Mana Cake", sell_in=5, quality=1),
  Item.new(name="Conjured Mana Cake", sell_in=-1, quality=5)
]
